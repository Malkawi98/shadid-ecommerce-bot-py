...
class KnowledgeBase:
    def __init__(self, file_path: str = KNOWLEDGE_BASE_PATH):
        ...
        self.loader = TextLoader(file_path, encoding='utf-8') # Specify encoding
        ...
        self._load_documents() # Load documents on initialization
...
# This line now runs AFTER load_dotenv() above
kb = KnowledgeBase()